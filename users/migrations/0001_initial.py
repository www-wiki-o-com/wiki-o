    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributions', models.ManyToManyField(blank=True, related_name='collaborators', to='theories.TheoryNode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.SmallIntegerField(choices=[(0, '----'), (10, 'Reported'), (14, 'Ignored'), (16, 'Accepted'), (18, 'Rejected')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(10, 'Pending'), (11, 'Pending'), (14, 'Ignored'), (15, 'Ignored'), (16, 'Accepted'), (17, 'Accepted'), (18, 'Rejected'), (19, 'Rejected'), (20, 'Nominated'), (21, 'Nominated'), (26, 'Accepted'), (27, 'Accepted'), (28, 'Rejected'), (29, 'Rejected'), (30, 'Nominated'), (31, 'Nominated'), (36, 'Accepted'), (37, 'Accepted'), (38, 'Rejected'), (39, 'Rejected'), (40, 'Nominated'), (41, 'Nominated'), (46, 'Accepted'), (47, 'Accepted'), (48, 'Rejected'), (49, 'Rejected')])),
                ('pub_date', models.DateTimeField()),
                ('modified_date', models.DateTimeField()),
                ('theory_node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='theories.TheoryNode')),
        ...
        migrations.AddField(
            ...
            name='feedback',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='users.UserFeedback'),
        ),
        migrations.AddField(
            model_name='feedbackcontribution',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='feedback_contributions', to=settings.AUTH_USER_MODEL),
        ),
    ]
