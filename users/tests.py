...
class LogInTest(TestCase):
    ...
    def test_post_signup(self):
        ...
        post_data = {'username':'Bob', 'email':'bob@gmail.com', 'password1':'bob!!!1234BOB', 'password2':'bob!!!1234BOB'}
...
class UserViews(TestCase):
    ...
    def test_post_profile(self):
        test_url  = reverse('users:profile-edit')
        post_data = {'username':'Bobarinio', 'fullname_visible':True, 'birth_date':datetime.date.today()}
