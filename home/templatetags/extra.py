...
RE_WIKI_O_URL = r'(https?://)?(www\.)?(m\.)?wiki-o\.com/(theory/\d+|evidence/\d+|opinion/\d+|opinion/\d+/vs/\d+|opinion/\d+/vs/%s|theory/\d+/%s|theory/%s/vs/\d+|theory/\d+/%s/vs/%s)/' % (RE_STATS, RE_STATS, RE_STATS, RE_STATS, RE_STATS)
