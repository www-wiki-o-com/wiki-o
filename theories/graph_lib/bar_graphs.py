...
@file       theories/graph_lib/bar_graphs.py
@brief      A collection of classes for creating, viewing, and manipulating bar graphs
...
from theories.graph_lib.shapes import Colour, Text, Rectangle, Group
