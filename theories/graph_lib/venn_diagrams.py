...
@file       theories/graph_lib/venn_diagrams.py
@brief      A collection of classes for creating, viewing, and manipulating Venn diagrams
...
from theories.graph_lib.shapes import Colour, Text
from theories.graph_lib.spring_shapes import Direction, Ring, EvidenceShape, SubtheoryShape, Wall
