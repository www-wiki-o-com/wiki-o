...
class TheoryNodeTests(TestCase):
    ...
    def setUp(self):
        ...
        self.fact       = create_test_evidence(parent_theory=self.theory, title='Fact',    fact=True,  created_by=self.user)
        self.fiction    = create_test_evidence(parent_theory=self.theory, title='Fiction', fact=False, created_by=self.user)
    ...
    def test_get_or_create_theory(self):
        node01 = TheoryNode.get_or_create_theory(true_title='Test', false_title='Test', created_by=self.user)
    ...
    def test_get_or_create_subtheory01(self):
        node01 = self.theory.get_or_create_subtheory(true_title='Test', false_title='Test', created_by=self.user)
    ...
    def test_get_or_create_evidence01(self):
        node01 = self.theory.get_or_create_evidence(title='Test', created_by=self.user)
    ...
    #******************************
    def test_str(self):
        node01 = self.theory.get_or_create_subtheory(true_title='Test01', false_title='XXX')
...
class StatsTests(TestCase):
    ...
    def test_get_owner_long(self):
        # blah
        self.assertEqual(self.stats.get_owner_long(), 'Statistics for Everyone')
