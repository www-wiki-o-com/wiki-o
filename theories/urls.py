...
urlpatterns = [
    ...
    path('theory/<int:pk>/opinion_<str:slug>/',         OpinionSlugView,                      name='opinion-slug'),
    ...
    path('opinion/<int:pk01>/vs/<int:pk02>/',           Opinion_User_vs_User_View,            name='opinion-user_vs_user'),
    path('opinion/<int:pk01>/vs/opinion_<str:slug02>/', Opinion_User_vs_Slug_View,            name='opinion-user_vs_slug'),
    path('theory/opinion_<str:slug01>/vs/<int:pk02>/',  Opinion_Slug_vs_User_View,            name='opinion-slug_vs_user'),
    path('theory/<int:theory_pk>/opinion_<str:slug01>/vs/opinion_<str:slug02>/',
          Opinion_Slug_vs_Slug_View,
          name='opinion-slug_vs_slug'
    ),
]
