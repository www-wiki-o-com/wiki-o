...
urlpatterns = [
    ...
    path('theory/<b64:content_pk>/opinions_<slug:opinion_slug>/',
         OpinionIndexView,
         name='opinion-index'),
    path('theory/<b64:content_pk>/opinion/<b64:opinion_pk>/',
         OpinionDetailView,
         name='opinion-detail'),
    path('theory/<b64:content_pk>/opinion/<slug:opinion_slug>/',
         OpinionDetailView,
         name='opinion-detail'),
    ...
    path('theory/<b64:content_pk>/opinion/<slug:opinion_slug01>/vs/<slug:opinion_slug02>/',
         OpinionCompareView,
         name='opinion-compare'),
    path('theory/<b64:content_pk>/opinion/<slug:opinion_slug01>/vs/<b64:opinion_pk02>/',
         OpinionCompareView,
         name='opinion-compare'),
    path('theory/<b64:content_pk>/opinion/<b64:opinion_pk01>/vs/<slug:opinion_slug02>/',
         OpinionCompareView,
         name='opinion-compare'),
    path('theory/<b64:content_pk>/opinion/<b64:opinion_pk01>/vs/<b64:opinion_pk02>/',
         OpinionCompareView,
         name='opinion-compare'),
]
