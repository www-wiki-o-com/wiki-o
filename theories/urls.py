...
urlpatterns = [
    ...
    path('theory/<b64:content_pk>/', theory_detail_view, name='theory-detail'),
    path('theory/<b64:content_pk>/edit/', theory_edit_view, name='theory-edit'),
    path('theory/<b64:content_pk>/merge/', theory_merge_view, name='theory-merge'),
    path('theory/<b64:content_pk>/report/', theory_report_view, name='theory-report'),
    path('theory/<b64:content_pk>/backups/', theory_backup_view, name='theory-backup'),
    path('theory/<b64:content_pk>/restore/', theory_restore_view, name='theory-restore'),
    path('theory/<b64:content_pk>/activity/', theory_activity_view, name='theory-activity'),
    ...
    path('theory/<b64:content_pk01>/inherit/<b64:content_pk02>/',
         theory_inherit_view,
         name='theory-inherit'),
    path('theory/<b64:content_pk>/del/', content_delete_redirect_view, name='theory-delete'),
    path('theory/<b64:content_pk>/remove/', content_remove_redirect_view, name='theory-remove'),
    path('theory/<b64:content_pk>/convert/', content_convert_redirect_view, name='theory-convert'),
    path('theory/<b64:content_pk>/revert/<int:version_id>/',
         content_revert_redirect_view,
         name='theory-revert'),
    path('theory/<b64:content_pk>/swap_titles/',
    ...
    path('theory/<b64:content_pk>/my_opinion/',
